    ...
    ui(new Ui::GameWindow)
{
    ...
    *background = background->scaled(this->size(), Qt::IgnoreAspectRatio);
    ...
    connect(this->ui->player1_skill_1,
	&QPushButton::clicked, player1, &Unit::useSkill1);
    connect(this->ui->player1_skill_2, 
	&QPushButton::clicked, player1, &Unit::useSkill2);
    connect(this->ui->player1_skill_3, 
	&QPushButton::clicked, player1, &Unit::useSkill3);
    connect(this->ui->player1_skill_4, 
	&QPushButton::clicked, player1, &Unit::useSkill4);
    connect(this->ui->player1_skill_5, 
	&QPushButton::clicked, player1, &Unit::useSkill5);

    connect(this->ui->player2_skill_1, 
	&QPushButton::clicked, player2, &Unit::useSkill1);
    connect(this->ui->player2_skill_2, 
	&QPushButton::clicked, player2, &Unit::useSkill2);
    connect(this->ui->player2_skill_3, 
	&QPushButton::clicked, player2, &Unit::useSkill3);
    connect(this->ui->player2_skill_4, 
	&QPushButton::clicked, player2, &Unit::useSkill4);
    connect(this->ui->player2_skill_5, 
	&QPushButton::clicked, player2, &Unit::useSkill5);
