    ...
    ui(new Ui::SinglePlayerWindow)
{
    ...
    *background = background->scaled(this->size(), Qt::IgnoreAspectRatio);
    ...
    connect(this->ui->player1_skill_11, &QPushButton::clicked,
	player1, &Unit::useSkill1);
    connect(this->ui->player1_skill_12, &QPushButton::clicked,
	player1, &Unit::useSkill2);
    connect(this->ui->player1_skill_13, &QPushButton::clicked,
	player1, &Unit::useSkill3);
    connect(this->ui->player1_skill_14, &QPushButton::clicked,
	player1, &Unit::useSkill4);
    connect(this->ui->player1_skill_15, &QPushButton::clicked,
	player1, &Unit::useSkill5);
    //Ai *ai = new Ai(player2);

    analysTimer = new QTimer;
    connect(analysTimer, &QTimer::timeout,
	this, &SinglePlayerWindow::analysAndHit);
    analysTimer->start(2000);

    connect(player1, &Unit::destroed,
	this, &SinglePlayerWindow::checkEnding);
    connect(player2, &Unit::destroed,
	this, &SinglePlayerWindow::checkEnding);
