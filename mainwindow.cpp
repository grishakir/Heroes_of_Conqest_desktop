    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(quitPushButton, &QPushButton::clicked, qApp, &QApplication::quit);
    connect(duelPushButton, &QPushButton::clicked, this, &MainWindow::duel);
    connect(singlePlayerPushButton, &QPushButton::clicked, this, &MainWindow::singlePlayer);
...
"So, it is really strong man! Push buttons to kill your enemy and save the United Kindom!");
}

void MainWindow::duel()
{
    gameWindow = new GameWindow();
    connect(gameWindow, &GameWindow::returnToMainWindow, this, &QMainWindow::show);
    connect(gameWindow, &GameWindow::returnToMainWindow, this, &MainWindow::delGameWindow);
    gameWindow->show();
    this->close();
}
